...
public class Memory8_2nd implements BfMemory {
    ...
    public Memory8_2nd () {
        current = new MemoryUnit( currentLength = BASE_MEMORY_SIZE );
        currentData = current.data;
    }

    public Memory8_2nd ( int size ) {
        current = new MemoryUnit( currentLength = size );
        currentData = current.data;
    }
    ...
    public int getAddress () {
        return currentOffset; // TODO: what about absolute address?
    }
    ...
    public void increaseAt ( int delta ) {
        ...
        if( newOffset >= 0 && currentOffset < currentLength ) {
            ...
            final byte v = currentData[oldOffset];
